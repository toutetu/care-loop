        ...
        <>
            ...
            <div className="flex flex-col gap-4 p-4">
                ...
                <Card>
                    <CardContent className="py-1">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                                <h1 className="text-lg font-semibold">{resident.name} 様</h1>
                                <p className="text-sm text-muted-foreground">
                                    {resident.nameKana}
                                    {resident.age !== null && ` ／ ${resident.age}歳`}
                                    {` ／ ${resident.gender}`}
                                </p>
                            </div>
                            <div className="flex flex-wrap items-center gap-2">
                                ...
                                <Badge variant="outline">
                                    利用曜日 {resident.weekdays.join('・') || '—'}
                                </Badge>
                                {resident.nextVisit && (
                                    <Badge variant="outline">次回 {resident.nextVisit}</Badge>
                                )}
                            </div>
                        </div>
                ...
                <Section
                    ...
                    action={
                        <Form
                            {...LlmActionController.detectRisks.form(resident.id)}
                    ...
                    {riskAssessment === null ? (
                        ...
                        <div className="space-y-4">
                            {!riskAssessment.isReviewed && (
                                <p className="flex items-start gap-2 rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-sm dark:border-amber-900 dark:bg-amber-950">
                ...
                <Section
                    ...
                    action={
                        <Form
                            {...LlmActionController.goalProgress.form(resident.id)}
                            options={{ preserveScroll: true }}
                        >
                            {({ processing }) => (
                                <Button
                        ...
                        <div className="space-y-4">
                            ...
                            {goalProgress.nextActions.length > 0 && (
                                <div>
                                    ...
                                    <ul className="list-disc space-y-0.5 pl-5 text-sm">
                                        {goalProgress.nextActions.map((action) => (
                                            <li key={action}>{action}</li>
                                        ))}
                                    </ul>
                                </div>
                ...
                {carePlan && (
                    ...
                    >
                        {carePlan.longTermGoal && (
                            <div className="mb-3">
                                <p className="text-xs font-medium text-muted-foreground">長期目標</p>
                                <p className="text-sm">{carePlan.longTermGoal}</p>
                            </div>
                        )}
                        <p className="text-xs font-medium text-muted-foreground">短期目標</p>
                                        ...
                                        <tr key={row.id}>
                                            ...
                                            <td className="py-2 text-right">
                                                <Button variant="ghost" size="sm" asChild>
                                                    <a
                                                        href={records.familyReport(row.id).url}
                                                        target="_blank"
                                                        rel="noreferrer"
                                                        title="連絡帳を印刷"
                                                    >
